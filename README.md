...
:point_right: As part of vocabulary of publishing with Bookiza, this git repository is the `manuscript` whereas the book i.e. &apos;consumer-ready&apos; distributable form is hosted _live_ on the url specified at the top.
